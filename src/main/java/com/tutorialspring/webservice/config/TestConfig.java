...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Order o1 = new Order(null, Instant.parse("2024-06-20T16:45:09Z"), u1);
    Order o2 = new Order(null, Instant.parse("2024-10-20T12:57:02Z"), u2);
    Order o3 = new Order(null, Instant.parse("2024-11-02T12:31:08Z"), u1);
